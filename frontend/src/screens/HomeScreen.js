        ...
        <Table striped bordered hover responsive variant="dark" >
          <thead>
            <tr>
              ...
              <th className="custom-cell bg-info"><img src="/icons/person.png" alt="icon" style={{width:'25px',height:'25px'}} />{' '}Yuboruvchi</th>
          ...
          <tbody>
            {filteredFiles.map((file, index) => (
             <TableRow page_type={'all'} file={file} index={index} />
            ))}
          </tbody>
        </Table>
        </Row>
